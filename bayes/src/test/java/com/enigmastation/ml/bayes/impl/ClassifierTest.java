...
public class ClassifierTest {
    ...
    public void testFisherCProb() {
        ...
        assertEquals(cl.fprob("quick", "good"), 0.571, 0.001);
        assertEquals(cl.fprob("monei", "bad"), 1.0, 0.001);
        assertEquals(cl.fisherprob("quick rabbit", "good"), 0.78, 0.001);
        assertEquals(cl.fisherprob("quick rabbit", "bad"), 0.356, 0.001);
